 ...
 * @Date: 2025-05-10 12:02:19
 * @LastEditors: Nagisa 2964793117@qq.com
 * @LastEditTime: 2025-05-10 12:02:57
 * @FilePath: \MDK-ARMf:\project\git\robotarm\Robotic_Arm\Core\Inc\usart - 副本.h
...
#define USART_RXBUFF_LIMIT 50 // 如果协议需要更大的buff,请修改这里
    // 模块回调函数,用于解析协议,需要传入一个参数,可以是module的指针或其他数据
    ...
    typedef struct
    {
        ...
        void *param;                           // 传入回调函数的参数,可以是module的指针或其他数据
    } USARTInstance;
    /* usart 初始化配置结构体 */
    typedef struct
    {
